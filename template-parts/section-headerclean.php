...
$fontcol = get_theme_mod('bcdl_header_font_color', '#fff');
...
<div class="header h-100" style="background-image: url('<?php echo wp_get_attachment_url( $headerId ) ?>'); background-position: center; background-size: cover;">
	...
	<div class="container h-100">
		<div class="row h-100 align-items-center justify-content-end" style="color: <?php echo esc_attr($fontcol); ?>;">
			<!-- <div class="col-md-6 text-white" style="background-color:rgba(9,37,93,0.0);"> -->
			<div class="col-md-6" style="background-color: <?php echo esc_attr($bg_color); ?>;">
