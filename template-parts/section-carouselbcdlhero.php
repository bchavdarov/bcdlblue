    ...
    <div class="carousel-inner">
      ...
      <?php for ($count=0; $count < 4; $count++) { ?>
        ...
        -->
            ...
            <div class="header d-block" style="height: 100vh; background-image: url('<?php echo wp_get_attachment_url( $bcdlcarouselmedia[$count] ) ?>'); background-size: cover; background-position: center center;">
        
                <div class="container h-100">
                    <div class="row h-100 align-items-center justify-content-end">
                    <div class="col-md-6 text-white" style="background-color:rgba(9,37,93,0.0);">
                        <h2 class="pt-4 display-3">Сидика ООД</h2>
                        <hr class="">
                        <p class="pb-4 display-6 bcdl-osc">Професионално кухненско оборудване</p>
                    </div>
                    </div>
                </div>
